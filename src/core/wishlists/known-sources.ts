...
export const BUILTIN_WISHLIST_SOURCES: WishlistSource[] = [
  ...
  {
    id: 'charles-aegis-tiered',
    name: 'Aegis Tiered (Charles)',
    url: 'https://raw.githubusercontent.com/charlesxcaliber/DIMAegisWeaponWishlist/main/MrCharlesWishlist_MRF_PPC0.txt',
    enabled: true,
    builtin: true,
    description:
      "Aegis spreadsheet rendered with full S-F tier coverage. Generated by MrCharles. The most permissive variant — flags any roll on any Aegis-rated weapon.",
    pveOriented: true,
    pvpOriented: false,
  },
];
